 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="staydesc" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "staydesc";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "staydesc") + "_chat_session";
